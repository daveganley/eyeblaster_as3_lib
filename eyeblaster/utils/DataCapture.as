...
{ 
	...
	public class DataCapture extends MovieClip
	{
		...
		private var _emailFormat:String = "Text";		//the mail format: text/html
		...
		public function DataCapture() 
		{
			...
			Tracer.debugTrace("Eyeblaster Workshop | DataCapture | You are currently using a deprecated version of the component, please import a newer version to stage.  For more information see the on-line help.",0);
			_init();
        }
		...
		public function getFormDistributionURL()
		{
			...
			var url = EB.urlParams.ebResourcePath + "PollingData/" + this._formName + "_" + EB.urlParams.ebCampaignID + ".xml";
		...
		private function _init():void
		{
			try
			{
				...
				EB.ebSetComponentName("DataCapture");
				//hide the component
				this.alpha = 0;
		...
		private function _postVars(pipeUrl):void
		{
			...
			pipeUrl = pipeUrl + "&ebAdID=" + EB.urlParams.ebAdID;
		...
		private function _postVarsTest(pipeUrl:String):void
		{
			...
			pipeUrl = pipeUrl + "&ebFormID=" + EB.urlParams.ebFormID;

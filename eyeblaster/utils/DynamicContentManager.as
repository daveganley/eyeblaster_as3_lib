//****************************************************************************
//class eyeblaster.utils.DynamicContentManager
//-----------------------------------------
...
package eyeblaster.utils
{
	...
	public class DynamicContentManager extends MovieClip
	{
		...
		public function DynamicContentManager()
		{
			...
			Tracer.debugTrace("Eyeblaster Workshop | DynamicContentManager | You are currently using a deprecated version of the component, please import a newer version to stage.  For more information see the on-line help.",0);
			this._init();
		}
		...
		public function LoadDataFromEBServer(fileName:String, type:String, callBack:Function)
		{
			...
			if(EB.urlParams["ebDCnt" + fileName])
				fileName = EB.urlParams.ebResourcePath + EB.urlParams["ebDCnt" + fileName];
			else
				fileName = EB.urlParams.ebResourcePath + "DynamicData/" +  fileName + "_" + EB.urlParams.ebCampaignID  +  ".txt";
		...
		private function _initComp()
		{
			...
			EB.ebSetComponentName("DynamicContentManager");
		...
		private function _initAttr():void
		{
			...
			try
			{
				...
				if(typeof(EB.urlParams.ebCampaignID) == "undefined")

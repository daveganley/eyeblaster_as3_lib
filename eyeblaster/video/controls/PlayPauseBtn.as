//****************************************************************************
//class eyeblaster.video.controls.PlayPauseBtn
//---------------------------------------
	...
	public class PlayPauseBtn extends BasePlayerCtrl
	{
		...
		public function PlayPauseBtn()
		{
			try
			{
				...
				ebGlobal.ebSetComponentName("PlayPauseBtn");
			}catch (error:Error)
			{
		...
		public override function handleEvent(evt:Object):void
		{
			try
			{
				Tracer.debugTrace("PlayPauseBtn: handle event type : "+evt.type + ", value: " + evt.value, 6);
